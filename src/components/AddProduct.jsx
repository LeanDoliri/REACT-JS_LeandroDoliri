...
const AddProduct = () => {
    ...
    const addToFirebase = async (title, artist, year, price, stock, img, description) => {
        ...
        <Container>
            ...
            <Form onSubmit={onSubmit}>
                ...
                <Form.Group className='' controlId='artist'>
                    <Form.Control className='imputForm mt-2 mb-2' type="text" placeholder="Artista"/>
                </Form.Group>
                <Form.Group className='' controlId='year'>
                    <Form.Control className='imputForm mt-2 mb-2' type="number" placeholder="Año" />
                </Form.Group>
                <Form.Group className='' controlId='price'>
                    <Form.Control className='imputForm mt-2 me-2 mb-2' type="number" placeholder="Precio" />
                </Form.Group>
                <Form.Group className='' controlId='stock'>
                    <Form.Control className='imputForm mt-2 mb-2' type="number" placeholder="Stock" />
                </Form.Group>
                <Form.Group className='' controlId='img'>
                    <Form.Control className='imputForm mt-2 mb-2' type="sting" placeholder="Portada" />
                </Form.Group>
